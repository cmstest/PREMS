    ...
    <div class="control-group <? if (!empty($error)): ?>error<? endif; ?>">
        <div class="form-group">
            <?php echo lang('login_identity_label', 'identity', array('class' => 'col-sm-2 control-label'));?>
            <div class="col-sm-3"><?php echo form_input($identity, NULL, 'class="form-control"'); ?></div>
        </div>

        <div class="form-group">
            <?php echo lang('login_password_label', 'password', array('class' => 'col-sm-2 control-label'));?>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10"><?php echo form_submit(array('class' => 'btn btn-primary btn-large', 'name' => 'login', 'value' => lang('login_submit_btn'))); ?></div>
        </div>
    </div>
    <?php echo form_close(); ?>
